package com.sunsheen.jfids.gef.usecase.plugin.demo.editor;
...
import com.sunsheen.jfids.gef.usecase.plugin.demo.factory.MyEditPartFactory;
import com.sunsheen.jfids.gef.usecase.plugin.demo.model.RootModel;
import com.sunsheen.jfids.gef.usecase.plugin.demo.util.PaletteUtil;
